...
//     }
    ...
    public function types(){
        return $this->belongsToMany(Type::class, 'percentages', 'year_union_id', 'type_id')->using(Percentage::class)->withPivot('percentage','min_grade_task','average_grade_task','min_average_grade_task')->withTimestamps();
    }
