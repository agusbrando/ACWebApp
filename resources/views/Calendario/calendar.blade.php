      ...
      <div class="row d-flex justify-content-center">
        ...
        <div class="col-md-4 bg-light border-left p-0 border-primary">
          ...
          <div id="buttons">
            ...
            <button type="submit" onclick="window.location.href='{{route('crearEvento',['fecha'=> $dia, 'hora' => $session->time_start->format('H:i')])}}'" class="btn btn-primary btn-block">{{ $session->time_start->format('H:i') }}</button>
            @endforeach
          </div>
        </div>
      </div>
