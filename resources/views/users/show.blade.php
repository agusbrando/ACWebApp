                            ...
                            <div class="card wizard-card" data-color="red" id="wizard">
                                <form action="" method="">
                                    ...
                                    <div class="wizard-header">
                                        ...
                                        <h5>Aqui encuentras la información de tu perfil.</h5>
                                    </div>
                                    <div class="wizard-navigation">
                                        <ul>
                                            <li><a href="#details" data-toggle="tab">Editar</a></li>
                                            <li><a href="#captain" data-toggle="tab">Cuenta</a></li>
                                            <li><a href="#description" data-toggle="tab">Eliminar</a></li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane" id="details">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <h4 class="info-text">Edita los datos de tu cuenta</h4>
                                                </div>
                                                <div class="col-sm-6">
                                        ...
                                        <div class="tab-pane" id="captain">
                                            <h4 class="info-text">Informacion de tu perfil </h4>
                                            <div class="row">
                                                ...
                                                <div class="py-10">
                                                    <div x-show.transition.in="step === 1">
                                                        <div class="mb-5 text-center">
                                                            ...
                                                            <div class="mx-auto w-48 text-gray-500 text-xs text-center mt-1">Click para añadir foto</div>
                                                        ...
                                                        <div class="mb-5">
                                                            <label for="firstname" class="font-bold mb-1 text-gray-700 block">Apellidos</label>
                                                            <p>{{($user->last_name)}}</p>
                                                        </div>
                                                        <div class="mb-5">
                                                            <label for="firstname" class="font-bold mb-1 text-gray-700 block">Email</label>
                                                            <p>{{($user->email)}}</p>
                                                        </div>
                                                        <div class="mb-5">
                                                            <label for="firstname" class="font-bold mb-1 text-gray-700 block">Rol ID</label>
                                                            <p>{{($user->role_id)}}</p>
                                                        </div>
                                        ...
                                        <div class="tab-pane" id="description">
                                            <div class="row">
                                                <h4 class="info-text"> Elimina la cuenta</h4>
